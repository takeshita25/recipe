...
- ### 麺
    ...
    - [梅とわかめのさっぱり冷製うどん](#梅とわかめのさっぱり冷製うどん)
...
- ### 魚介
    ...
    - [たらグラタン](#たらグラタン)
    - [金目鯛エスニック風](#金目鯛エスニック風)
    - [カレイのアラクレーム](#カレイのアラクレーム)
    - [マグロのたたき](#マグロのたたき)
    - [ホタテとアボカドのタルタル](#ホタテとアボカドのタルタル)

- ### サラダ
    <!-- - [ヨーグルトソースのポテトサラダ](#ヨーグルトソースのポテトサラダ) -->
    - [ささみときゅうりの中華風ごま酢サラダ](#ささみときゅうりの中華風ごま酢サラダ)
    - [ささみともやしのカレーマヨ和え](#ささみともやしのカレーマヨ和え)
...
## 梅とわかめのさっぱり冷製うどん
<img src="./img/plumSeaweedUdon.jpg" width="250">
...
1. (乾燥の場合)わかめを水に戻しておく
2. お湯を沸かし、うどんをゆでる
3. 梅を開き、種を取り除いてから叩いてペースト状にする
4. 大葉を千切りにし、ちくわは斜めに0.5cm幅程度で切る
5. 2.のうどんが茹であがったら、流水と氷でしめてお皿に盛る
6. めんつゆを注ぎ、水気を切った1.と3., 4.を盛り、最後に白ごまと万能ネギ(小口切り)を散らす
...
## ポキ丼
<img src="./img/pokiBowl.jpg" width="250">
...
【工程】
1. 合わせ調味料[A]を耐熱容器に入れて600Wで30秒加熱する
2. 1.に合わせ調味料[B]を加え混ぜる
3. マグロを一口大の角切りにし、2.に漬け込んでおく(30分～1晩)
4. アボカドを角切りにし、温泉卵を作っておく
※温泉卵： お湯が沸騰したら火を止め、冷蔵庫から出したての卵を入れて9分放置
5. 丼にご飯を盛り、3., 4.を盛り付ける
6. 最後に刻みのりを散らす
...
## ささみときゅうりの中華風ごま酢サラダ
<img src="./img/chickenBreastCucumber.jpg" width="250">
...
## ささみともやしのカレーマヨ和え
<img src="./img/beanSproutsCurry.jpg" width="250">
...
【工程】
1. もやしは好みの加減(ある程度、食感が残るくらいが良い)に茹で、ざるに広げて粗熱を取っておく
2. お湯を沸騰させた後、弱火-中火にしてからささみを入れ、2分ほど茹であたら火を消して余熱で火を通す（箸でほぐしてみて火が通っていればOK）
3. ささみを上げ、冷めたらもやしのサイズに合わせて手で細かく裂く
4. たれ[A]の材料を合わせ、水気が出ないように食べる直前にすべてをあえて器に盛る
5. 最後に万能ねぎ(小口切り)を散らす
...
## たらグラタン
<img src="./img/codGratin.JPG" width="250">
...
【工程】
1. 調味料を混ぜる
2. エビ、椎茸を粗みじんにして、サラダ油で軽く火を通して冷ましておく
3. 2.が冷めたら1.を入れて混ぜておく
4. 鱈に塩・こしょう、小麦粉をまぶし、バターで焼く
5. 耐熱皿に4.、3.を入れオーブンで10-15分程焼く
...
【工程】
1. 魚に塩を振って置いておく(30-60分)
2. 長ネギを5cm幅に切って白髪ネギにし、氷水にさらしておく
3. 調味料を鍋に入れ煮立て、生姜1片を皮付きのまま薄切りにしたもの、ネギの青い部分をいれる
4. 魚から出てきた水分（くさみ）を拭くか、洗い流し、水気を切ってから3に魚の皮を上にして入れ、フタをして弱火で5分煮る
5. 白髪ネギ、パクチーを乗せる
...
## カレイのアラクレーム
<img src="./img/alacreme.JPG" width="250">
...
【工程】
1. 魚に塩を振って置いておく(30-60分)
2. にんにく、玉ねぎ、アンチョビをみじん切りにする
3. フライパンにオリーブオイルを入れ、にんにく、玉ねぎを炒める
4. 3.にアンチョビとバターを加え更に炒める
5. 4.に生クリームとコンソメを入れる(少ししょっぱいのでコンソメの量は要調整)
6. 1.をオリーブオイルで焼く(蓋をして蒸すイメージ)
7. 6.に5.をかける(お好みでイタリアンパセリやディルなどを添える)
...
【工程】
1. にんにくをスライスする(30-60分)
2. ジップロックにマグロと1.と調味料を入れ、半日漬け込んでおく
3. フライパンにサラダ油を入れ、2.のニンニクでチップを作り、よけておく
4. 同じフライパンで2.のマグロ全面にサッと火を通す(固くなるので軽く)
5. 長ネギを5cm幅に切って白髪ネギにし、氷水にさらしておく
6. 大葉を千切りにする
7. マグロを一口大に切り、漬け込んでおいたタレをかけ、5.と6.を乗せる
...
## ホタテとアボカドのタルタル
<img src="./img/scallopsAvocado.JPG" width="250">
...
【工程】
1. セロリを薄くスライスして塩もみしておく
2. アボカドをさいの目に切ってフォークで潰す
3. 1.と2.を混ぜて、調味料を混ぜる
4. ホタテを小さくぶつ切りにし、塩、レモン汁、オリーブオイルで混ぜておく
5. 3.の上に4.を乗せ、オリーブオイルと塩を少しまぶしたべビリーフと粒マスタードを上に乗せる
